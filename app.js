...
function tintSheet(c){const sp=$("sheet");if(!sp)return;if(c){sp.style.background="linear-gradient(180deg,"+hexA(c,.16)+","+hexA(c,.04)+")"}else{sp.style.background=""}}
...
async function init(){
    ...
    if(sv&&!document.getElementById("verLine")){const v=document.createElement("div");v.id="verLine";v.style.cssText="opacity:.55;font-size:12px;text-align:center;padding:6px 0 2px";v.textContent="LostNote v21 \u00b7 transfer v3";sv.appendChild(v)}
